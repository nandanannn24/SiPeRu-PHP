...
<head>
    <meta charset="UTF-8">
    <title>Surat Balasan Persetujuan Ruangan Fakultas</title>
    <style>
        @page {
...
<body>
    <div class="header">
        <h2>Surat Balasan Persetujuan Peminjaman Ruangan</h2>
        <p>Universitas Pembangunan Nasional "Veteran" Jawa Timur</p>
    </div>

    <div class="content">
        <p>Dengan hormat,</p>
        <p>Memperhatikan surat permohonan peminjaman ruangan tingkat fakultas, atas nama:</p>
        ...
        <ul>
            ...
            <li><strong>Jenis:</strong> Dalam Fakultas</li>
        </ul>

        <p>Maka dengan ini diberitahukan bahwa permohonan <strong>DISETUJUI</strong> oleh Kaprodi, Dekan III Bidang Kemahasiswaan, dan TU Fakultas.</p>
        <p>Diharapkan peminjam dapat menjaga kebersihan dan ketertiban selama penggunaan ruangan.</p>

        <br>
        <p style="text-align: right;">Surabaya, {{ $tanggalSurat }}</p>

        {{-- ── 2-column signature layout (internal fakultas) ── --}}
